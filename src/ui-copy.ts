export const UI_COPY = {
  ...
  search: {
    title: "Buscar por numero de serie",
    description: "Escanea o escribe el numero de serie del producto. Tambien acepta nombre, categoria o marca.",
    label: "Numero de serie",
    placeholder: "Escanea o ingresa el numero de serie",
    buttonAriaLabel: "Buscar producto",
    transferTitle: "Mover producto",
    transferShelfLabel: "Estante destino",
    transferSectionLabel: "Piso destino",
    advancedToggle: "Modo avanzado: colocar en una posicion exacta",
    advancedHint: "Activa la edicion 3D para arrastrar este producto a una posicion exacta dentro del estante. Util para acomodos finos.",
    advancedStart: "Iniciar colocacion en 3D"
  },
  productForm: {
